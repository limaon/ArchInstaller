...
##
##	* format_font()
##	  A small helper function to generate color formatting codes from simple
...
##		6. Formatting of the bash promt ($PS1).
##
##	* Main script body:
...
bash_prompt() {
	...
	############################################################################
	## TEXT FORMATING                                                         ##
	## Generate the text formatting according to configuration                 ##
	############################################################################
